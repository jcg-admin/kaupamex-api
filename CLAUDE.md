...
Submódulo `api` del monorepo PracticaYoruba (repo GitHub `jcg-admin/e-comerce-api`).
...
- **`../e-comerce/.claude/CLAUDE.md`** — identidad, flujo de sesión, glosario.
- **`../e-comerce/.claude/rules/`** — reglas no negociables cargadas en cada
...
bash /home/user/e-comerce-db/scripts/start_db.sh        # o: make db-up
