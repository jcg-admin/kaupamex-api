...
from apps.addons.payments.gateways.paypal import PayPalGateway
from apps.addons.payments.gateways.base import BaseGateway
...
def mock_paypal_api():
    ...
    with patch('apps.addons.payments.gateways.paypal.requests') as mock_req:
        # Token endpoint
