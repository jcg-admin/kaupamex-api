...
from addons.inventory.tasks import scan_low_stock


class TestScanLowStock:

    @patch('addons.inventory.tasks._maybe_create_alert')
    @patch('addons.inventory.tasks.ProductVariant')
    @patch('addons.inventory.tasks.Product')
    @patch('addons.inventory.tasks.SiteSettings')
