...
from addons.authz.services import BUYER_ROLE_CODE
from addons.users.models import EmailVerificationToken
from addons.users.tokens_email import create_verification_token, send_verification_email
