...
from apps.addons.users.models import EmailVerificationToken
from apps.addons.users.tokens_email import create_verification_token, send_verification_email
