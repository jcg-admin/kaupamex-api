...
the sanctioned no-Celery pattern already used by apps.modules.backups: a job record
...
from apps.modules.reports import views as reports_views
from apps.modules.reports.models import ExportJob
