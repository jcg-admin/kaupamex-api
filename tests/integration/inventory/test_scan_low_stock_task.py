...
class TestScanLowStock:
    ...
    @patch('apps.inventory.tasks._maybe_create_alert')
    @patch('apps.inventory.tasks.ProductVariant')
    @patch('apps.inventory.tasks.Product')
    @patch('apps.inventory.tasks.SiteSettings')
