...
class TestCancelGuide:
    ...
    def test_admin_cancela_guia_creada(
        ...
        r = admin_client.post(f'/api/v2/logistics/guides/{g.id}/cancel/',
    ...
    def test_no_cancela_guia_entregada(
        ...
        r = admin_client.post(f'/api/v2/logistics/guides/{g.id}/cancel/', {}, format='json')
        assert r.status_code == 400
    ...
    def test_cancela_guia_404_loud(self, admin_client, db):
        r = admin_client.post('/api/v2/logistics/guides/999999/cancel/', {}, format='json')
        assert r.status_code == 404
        assert r.json()['codigo_error'] == 'SHIPMENT_GUIDE_NOT_FOUND'
