...
En kaupamex no existe `.thyrox/registry/`; este coordinator usa la definición
de grupos declarada en este archivo y el estado del `progreso-<slug>.rst`.

## Arranque

1. Leer `progreso-<slug>.rst` de la iniciativa activa
