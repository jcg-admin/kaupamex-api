...
urlpatterns = _admin_urls + [
    ...
    path('api/v2/admin/',          include(('core.admin_urls', 'admin_core'),           namespace='admin_core_v2')),
    ...
    path('api/v2/admin/',   include(('addons.voucher.urls', 'admin_voucher'),                           namespace='admin_voucher_v2')),
