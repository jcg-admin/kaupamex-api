"""Vistas admin — apps.platform.authz.
...
from apps.platform.authz.admin_serializers import (
    AdminRoleSerializer, RolePermissionsWriteSerializer, capability_rows,
    is_noun,
)
from apps.platform.authz.models import AccessLevel, Capability, Role, RoleAssignment, RoleCapability
