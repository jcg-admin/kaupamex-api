"""Serializers admin — apps.platform.authz.
...
Complementa ``apps.platform.authz.serializers`` (superficie del usuario autenticado).
...
from apps.platform.authz.models import AccessLevel, Role
