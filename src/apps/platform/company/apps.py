"""AppConfig — apps.platform.company (capa L1 de la plataforma Kaupamex).
...
puerta L1 sobre el catálogo de capacidades L2 de ``apps.platform.authz``). FK
