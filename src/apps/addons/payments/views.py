...
from apps.addons.orders.models import Order, OrderItem, OrderValue, OrderAddress, ShippingZone
from apps.addons.orders.proxy_models import DeliveredOrder
...
from apps.addons.notifications.emails import send_card_verification_email
from .gateways.mercadopago import MercadoPagoGateway
from apps.addons.users.models import Address
from apps.addons.settings_app.models import ShippingMethod, SiteSettings
...
from apps.addons.orders.views import CheckoutView
from apps.addons.orders.serializers import CheckoutSerializer, OrderSerializer
