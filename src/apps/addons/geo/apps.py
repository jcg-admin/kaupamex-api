"""AppConfig — apps.addons.geo (catálogos geográficos de referencia).

Aloja catálogos de referencia geográfica reutilizables (códigos postales
SEPOMEX ahora; extensible a otros). Se separa de ``apps.addons.users`` para aislar
