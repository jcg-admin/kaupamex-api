...
from apps.addons.catalogue.utils import category_upload_path, product_image_upload_path
...
class Product(TimeStampedModel, SoftDeleteModel):
    ...
    # (apps.addons.logistics.offers: costo = base + $/kg × peso_total). Nullable:
...
class ProductDiscount(TimeStampedModel, SoftDeleteModel):
    ...
    Distinto de Voucher (apps.addons.voucher): no tiene codigo y se aplica
