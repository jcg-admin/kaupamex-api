"""
Serializers — apps.addons.settings_app
...
from apps.addons.orders.delivery import delivery_estimate_dict
...
class ShippingZoneSerializer(serializers.ModelSerializer):
    ...
    Relación con SEPOMEX (``apps.addons.geo.CatalogPostalCode``): el ``zip_code_prefix``
