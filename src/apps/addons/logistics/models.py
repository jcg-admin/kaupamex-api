"""
Models — apps.addons.logistics (P-13 / UC-LOG-01..09).
...
from apps.addons.logistics.offers import RateCard
...
class Courier(TimeStampedModel):
    ...
    # pattern as apps.addons.settings_app.PaymentGateway.credentials, DEC-DOC-008) —
...
class CarrierRateCard(TimeStampedModel):
    ...
    cotización (apps.addons.logistics.offers). Separado de ``Courier`` (que modela
