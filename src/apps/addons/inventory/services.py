"""
InventoryService — apps.addons.inventory
...
- Sprint 12: desde apps.addons.cart al hacer checkout
- Sprint 18: desde apps.addons.orders al confirmar pago (UC-ORD-07)
"""
import logging
...
from apps.addons.chartsize.models import ProductVariant
