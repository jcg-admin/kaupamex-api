...
class CsrfExemptSessionScheme(SessionScheme):
    ...
    """
    target_class = 'apps.addons.users.authentication.CsrfExemptSessionAuthentication'
    name = 'cookieAuth'
...
class PYTokenObtainPairSerializerExtension(OpenApiSerializerExtension):
    ...
    """
    target_class = 'apps.addons.users.tokens.PYTokenObtainPairSerializer'
