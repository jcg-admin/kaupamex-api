"""
apps.addons.contact — UC-COM (formulario publico de contacto).

Frontera con apps.addons.support (D-001):
  apps.addons.contact  -> mensajes anonimos (no requieren autenticacion) enviados
  ...
  apps.addons.support  -> tickets estructurados con workflow, hilo de respuestas,
