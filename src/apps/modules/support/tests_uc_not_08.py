...
from apps.modules.notifications.service import notify_support_closed
from apps.modules.support.models import SupportTicket, SupportTicketReply
from apps.modules.support.management.commands.auto_close_support_tickets import AUTO_CLOSE_DAYS
