"""
InventoryService — apps.modules.inventory
...
- Sprint 12: desde apps.modules.cart al hacer checkout
- Sprint 18: desde apps.modules.orders al confirmar pago (UC-ORD-07)
"""
import logging
...
from apps.modules.chartsize.models import ProductVariant
