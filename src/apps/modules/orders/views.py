...
from apps.modules.cart.views import _get_or_create_cart
...
from apps.modules.catalogue.models import ProductImage
...
class CheckoutView(APIView):
    ...
    def post(self, request):
        ...
        # extensión (cobro bajo-umbral, PENDIENTE) vive en apps.modules.orders.shipping:
