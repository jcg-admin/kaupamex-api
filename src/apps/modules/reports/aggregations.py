"""
Aggregations — apps.modules.reports
...
from apps.modules.orders.models import Order, OrderValue, OrderItem
from apps.modules.payments.models import Payment
from apps.modules.catalogue.models import Product
from apps.modules.inventory.models import StockAlert
