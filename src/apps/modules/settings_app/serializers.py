"""
Serializers — apps.modules.settings_app
...
from apps.modules.orders.delivery import delivery_estimate_dict
...
class ShippingZoneSerializer(serializers.ModelSerializer):
    ...
    Relación con SEPOMEX (``apps.modules.geo.CatalogPostalCode``): el ``zip_code_prefix``
