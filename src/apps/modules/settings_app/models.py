"""
Models — apps.modules.settings_app
...
class SiteSettings(TimeStampedModel):
    ...
    # recibo PDF. El helper de PDF (apps.modules.payments.pdf_receipt) ya resuelve el
...
class PaymentGateway(TimeStampedModel):
    ...
    credentials = models.BinaryField(
        help_text='Credenciales cifradas con Fernet (apps.modules.settings_app.models._fernet_key)')
