...
class CsrfExemptSessionScheme(SessionScheme):
    ...
    """
    target_class = 'apps.modules.users.authentication.CsrfExemptSessionAuthentication'
    name = 'cookieAuth'
...
class PYTokenObtainPairSerializerExtension(OpenApiSerializerExtension):
    ...
    """
    target_class = 'apps.modules.users.tokens.PYTokenObtainPairSerializer'
