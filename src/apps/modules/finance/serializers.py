"""Serializers — apps.modules.finance (UC-FIN-06 CashConcept, UC-FIN-01 settlements)."""
from rest_framework import serializers

from apps.modules.finance.exceptions import DuplicateCode, ImmutableField
from apps.modules.finance.models import (
