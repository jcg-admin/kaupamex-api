...
from apps.modules.catalogue.utils import category_upload_path, product_image_upload_path
...
class Product(TimeStampedModel, SoftDeleteModel):
    ...
    # (apps.modules.logistics.offers: costo = base + $/kg × peso_total). Nullable:
...
class ProductDiscount(TimeStampedModel, SoftDeleteModel):
    ...
    Distinto de Voucher (apps.modules.voucher): no tiene codigo y se aplica
