"""
Models — apps.modules.logistics (P-13 / UC-LOG-01..09).
...
from apps.modules.logistics.offers import RateCard
...
class Courier(TimeStampedModel):
    ...
    # pattern as apps.modules.settings_app.PaymentGateway.credentials, DEC-DOC-008) —
...
class CarrierRateCard(TimeStampedModel):
    ...
    cotización (apps.modules.logistics.offers). Separado de ``Courier`` (que modela
