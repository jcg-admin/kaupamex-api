"""Provider payment_stripe — Stripe.

Scaffold fiel al patrón provider de Odoo (payment_stripe en
...
_PENDING = (
    'Provider Stripe registrado en el framework payment; '
    'integración pendiente (sin credenciales ni flujo cableado).'
)


class StripeGateway(BaseGateway):
    """Provider Stripe — contrato registrado, integración pendiente."""
