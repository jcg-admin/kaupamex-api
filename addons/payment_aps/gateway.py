"""Provider payment_aps — Amazon Payment Services.

Scaffold fiel al patrón provider de Odoo (payment_aps en
...
_PENDING = (
    'Provider Amazon Payment Services registrado en el framework payment; '
    'integración pendiente (sin credenciales ni flujo cableado).'
)


class ApsGateway(BaseGateway):
    """Provider Amazon Payment Services — contrato registrado, integración pendiente."""
...
register_gateway('APS', ApsGateway)
