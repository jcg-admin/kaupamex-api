"""Provider payment_authorize — Authorize.Net.

Scaffold fiel al patrón provider de Odoo (payment_authorize en
...
_PENDING = (
    'Provider Authorize.Net registrado en el framework payment; '
    'integración pendiente (sin credenciales ni flujo cableado).'
)


class AuthorizeGateway(BaseGateway):
    """Provider Authorize.Net — contrato registrado, integración pendiente."""
...
register_gateway('AUTHORIZE', AuthorizeGateway)
