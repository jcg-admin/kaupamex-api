...
# `res.groups`), no un addon aparte — ver H-API-562.
{
    ...
    # `depends` MEDIDO da seis destinos; sólo se declara UNO. Los otros cinco
    ...
    # #322:
    #
    #   authz_audit        services.py:20, controllers/main.py:16
    #   authz_reauth       services.py:35, controllers/main.py:19
    #   observability      controllers/admin_main.py:40
