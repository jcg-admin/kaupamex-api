...
from .views import (
    ...
    CourierDetailView, CourierListView, LogisticsPanelView,
...
urlpatterns = [
    ...
    path('guides/<int:pk>/',                ShipmentGuideDetailView.as_view(),
         name='guide-detail'),
    path('guides/<int:pk>/cancel/',         CancelGuideView.as_view(),
         name='guide-cancel'),
    path('guides/<int:pk>/confirm-delivery/', ConfirmDeliveryView.as_view(),
         name='confirm-delivery'),
    path('buyer/order/<int:order_id>/guide/', BuyerGuideView.as_view(),
         name='buyer-guide'),
]
