"""
Rutas de la API v2 — apps.inventory (rutas de administración)

Registradas en config/urls.py bajo api/v2/admin/.
Mismas vistas que v1. Paths específicos de variante antes del catch
por product_pk para evitar colisiones.
"""
...
urlpatterns = [
    ...
    # Rutas de variante específicas — DEBEN ir antes del <int:product_pk> catch
