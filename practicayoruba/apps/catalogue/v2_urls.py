"""
Rutas de la API v2 — apps.catalogue (rutas públicas)

Registradas en config/urls.py bajo api/v2/catalogue/.
Mismas vistas que v1; slug catch-alls al final para evitar
capturar prefijos específicos.
"""
